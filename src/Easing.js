...
export default class EasingAnimation extends React.Component {
  constructor() {
    super();
      ...
      <SafeAreaView style={styles.flex}>
        ...
        <ScrollView>
          <View style={[styles.flex, styles.container]}>
            ...
            <Btn
              title="Elastic"
              onPress={() => this.animate(Easing.elastic(1))}
            />
            ...
            <Btn
              title="Back"
              onPress={() => this.animate(Easing.back(1.70158))}
            />
            ...
            <Btn
              title="Bezier"
              onPress={() => this.animate(Easing.bezier(0.5, 0.1, 0.7, 1))}
            />
...
const Btn = props => (
  <Button type="outline" buttonStyle={styles.btn} {...props} />
);
